                ...
                if (this.state.userName !== '' && this.state.password !== '') {
                    if (userlen > 0 && userlen === 1) {
                        if (user[0].username === this.state.userName && user[0].password === this.state.password) {
                            ...
                            this.props.history.push('/admin/index' + user[0].id);
                        }
                    }
                    else {
                        return (
            ...
            <div className="cont">
                <div class="container">
                    <div class="row welcome">
                       <div class="col-lg-6">
                              <img src={loginPage} className="img" />
                       </div>
                       <div class="col-lg-6">
                           <div class="row">
                               <div class="col-md-6 offset-md-3 mt-4">
                                   <form>
                                     <div className="container1">
                                       ...
                                       <p class="content"> Welcome back! Please login to continue 
                                       </p> 
                                       <p> <span class="required">Complaint Officer Login</span>                                       </p>
                                       <div class="row">
                                               ...
                                               <div class="col-sm-6 ">
                                                   <div class="form-group form-check">
                                                       ...
                                                       <button type="submit" onClick={(event) => this.getdata(event)} className="button" onClick={(event) => this.move(event)}>
							                               <strong className="input-button">Sign In</strong>
						                               </button>
                                                   </div>
                                               </div>
                                           </div>
